...
def main():
    ...
    random.seed(42)
    user_id_list = [random.randint(0, 900) for _ in range(10)] # Replace with the target user ID
    ...
    for user_id in user_id_list:
        ...
        prompt = generate_prompt(user_profiles[user_id], history_window, top_k=5,
